...
//Propuesta
module.exports.getInversoresCotizacion = async function(_data){
	let _arrayInversor = [];
	let data = _data;
...
//@static
async function getEquiposCombinacionMicros(vNombreMaterialFotovoltaico){
	/* [Descripcion]
	...
	*/
	...
	try{
		...
		NombresEquipos.primerEquipo = await this.consultarEquipoPorNombre({ vNombreMaterialFot: NombresEquipos.primerEquipo });
		...
		NombresEquipos.segundoEquipo = await this.consultarEquipoPorNombre({ vNombreMaterialFot: NombresEquipos.segundoEquipo });
...
module.exports.insertar = async function(datas){
	return await inversor.insertarBD(datas);
}

module.exports.eliminar = async function(datas){
	return await inversor.eliminarBD(datas);
}

module.exports.buscar = async function(idInversor){
	return await inversor.buscarBD(idInversor);
}

module.exports.editar = async function(datas){
	return await inversor.editarBD(datas);
}

module.exports.consultar = async function(){
	return await inversor.consultaBD();
}

module.exports.consultarEquipos = async function(vTipoInversor){
	return await inversor.buscarTipoInversor(vTipoInversor);
}

module.exports.consultarEquipoPorNombre = async function(vNombreMaterialFot){
	return await inversor.buscarInversorPorNombre(vNombreMaterialFot);
}