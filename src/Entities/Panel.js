...
module.exports.insertarBD = async function(datas){
	...
	try{
		...
		throw 'Error Panel.insertarBD: '+error;
	}
}
...
module.exports.eliminarBD = async function(datas) {
	try{
		...
		throw 'Error Panel.eliminarBD(): '+error;
	}
}
...
module.exports.editarBD = async function(datas){
	try{
		...
		throw 'Error Panel.editarBD: '+error;
	}
}
...
module.exports.consultaBD = async function(){
	try{
		...
		throw 'Error Panel.consultaBD: '+error;
	}
}
...
module.exports.buscarBD = async function(datas){
	try{
		...
		throw 'Error Panel.buscarBD: '+error;
	}
}