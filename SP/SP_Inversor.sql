...
BEGIN
    ...
    ELSEIF (Opcion = 3) THEN
        SELECT HEX(idInversor) AS idInversor, vTipoInversor, vNombreMaterialFot, vMarca, fPotencia, vRangPotenciaPermit, siNumeroCanales, siPanelSoportados, fPrecio, cTipoMoneda, vGarantia, vOrigen, fISC, iVMIN, iVMAX, iPMAX, iPMIN, bAccesorio, bMonitoreo, created_at, updated_at
        FROM inversor
